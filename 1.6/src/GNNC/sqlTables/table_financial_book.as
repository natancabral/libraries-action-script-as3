package GNNC.sqlTables
{
	...
	public class table_financial_book
	{
		...
		public var _TABLE:String 				= 'FINANCIAL_BOOK';
		
		public var ID:uint						= 0;
		public var ID_KEY:String				= '';
		public var ID_FINANCIAL_ACCOUNT:uint	= 0; //Centro de Custo
		...
		public function table_financial_book(ID_:uint=0)
		{
			ID = ID_;
			table_info();
		}
