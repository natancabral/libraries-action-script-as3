package GNNC.sqlTables
{
	...
	public class table_job
	{
		...
		public var ID_CLIENT_INSERT:uint			= 0;
		public var IDS_CLIENT_TEAM:String			= '';
		...
		public function table_job(ID_:uint=0)
		{ 
			ID = ID_;
			table_info();
		}
