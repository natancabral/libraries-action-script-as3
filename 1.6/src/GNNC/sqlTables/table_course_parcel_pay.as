package GNNC.sqlTables
{
	...
	public class table_course_parcel_pay
	{
		...
		public var _TABLE:String 			= 'COURSE_PARCEL_PAY';
		...
		public var ID_COURSE_PARCEL:uint	= 0;
		public var ID_FINANCIAL:uint		= 0;

		public function table_course_parcel_pay(ID_:uint=0)
		{
			ID = ID_;
			table_info();
		}
