package GNNC.sqlTables
{
	...
	public class table_course_frequency
	{
		...
		public var _TABLE:String 				= 'COURSE_FREQUENCY';
		...
		public var FREQUENCY:uint; // 0 --> Indefinido  1 --> Presente  2 --> Ausente
		public var TYPE:String; // --> or GLOBAL
		public var DATE_START:String;
		public var DATE_END:String;
		public var PERIOD:uint;

		public function table_course_frequency(ID_:uint=0)
		{
			ID = ID_;
			table_info();
		}
