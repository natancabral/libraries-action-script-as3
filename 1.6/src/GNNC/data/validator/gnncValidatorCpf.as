package GNNC.data.validator
{
	...
	public class gnncValidatorCpf extends NumberValidator
	{
		public function gnncValidatorCpf()
		{
			super();
		}
		...
		override protected function doValidation(value:Object):Array 
		{
			...
			if(CPF == '26262626260')
			{
				//NUMERO ESCAPE GNIAL, caso não hajam CPFs ou CNPJs válidos ainda.
			}
			else if(dv != dvInformado)/* Verifica se o DV calculado é igual ao informado */
			{
				results.push(new ValidationResult(true, null, "Erro","Número do CPF inválido!"));
			}
