package GNNC.data.file
{
	...
	public class gnncFileSqlLite2
	{
		...
		*/
		[Bindable]
		public var _executing:Boolean = false; 
		...
		public function start():void
		{
			...
			*/
			var db:File = File.documentsDirectory.resolvePath("GNNC/DataBaseSqlLite/money3.db");
		...
		public function __query(sql_:String):void
		{
		...
		// function to add item to our database
		public function addItem(first_name:String,last_name:String):void
		{
			...
			sqls.text = "INSERT INTO test_table (first_name, last_name) VALUES('"+first_name+"','"+last_name+"');";
			sqls.execute();
		...
		public function remove(id_:uint):void
		{
			...
			sqls.text = "DELETE FROM test_table WHERE id="+id_;
			sqls.execute();
