/**
 * Copyright nemo324 ( http://wonderfl.net/user/nemo324 )
 * MIT License ( http://www.opensource.org/licenses/mit-license.php )
 * Downloaded from: http://wonderfl.net/c/ilur
 */
...
package GNNC.data.bitmap
{
    ...
    public class gnncBitmapDraw2 extends MovieClip 
	{
		...
		public function gnncBitmapDraw2():void {
            init()
            drawInterface()
		}
...
import GNNC.data.bitmap.gnncBitmapDraw2;

class ColorButton extends MovieClip {
    
    private var color:uint
    private var parentMC:gnncBitmapDraw2

    public function ColorButton(color:uint, parentMC:gnncBitmapDraw2) {
        this.color = color
...
class TicknessButton extends MovieClip {
    ...
    public function TicknessButton(tickness:int, parentMC:gnncBitmapDraw2) {
