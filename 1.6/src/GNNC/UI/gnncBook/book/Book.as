package GNNC.UI.gnncBook.book {
	
	
	import GNNC.UI.gnncBook.pageflip.PageFlip;
	import GNNC.UI.gnncBook.geom.Geom;
	import GNNC.UI.gnncBook.managers.StateManager;
	...
	import GNNC.UI.gnncBook.pageflip.DistortImage;
	 ...
	 */
	[Event(name="pageflipStarted", type="GNNC.UI.gnncBook.book.BookEvent")]
	/**
	 ...
	 */
	[Event(name="pageflipEnding", type="GNNC.UI.gnncBook.book.BookEvent")]
	/**
	 ...
	 */
	[Event(name="pageflipFinished", type="GNNC.UI.gnncBook.book.BookEvent")]
	/**
	 ...
	 * @see			Book#hover
	 */
	[Event(name="hoverStarted", type="GNNC.UI.gnncBook.book.BookEvent")]
	/**
	 ...
	 * @see			Book#hover
	 */
	[Event(name="hoverEnding", type="GNNC.UI.gnncBook.book.BookEvent")]
	/**
	 ...
	 * @see			Book#hover
	 */
	[Event(name="hoverFinished", type="GNNC.UI.gnncBook.book.BookEvent")]
	/**
	 ...
	 * @see			BookEvent#PAGE_TURNED
	 */
	[Event(name="bookOpened", type="GNNC.UI.gnncBook.book.BookEvent")]
	/**
	 ...
	 * @see			BookEvent#PAGE_TURNED
	 */
	[Event(name="bookClosed", type="GNNC.UI.gnncBook.book.BookEvent")]
	/**
	 * Dispatched at the same time as the page-turned Event, when the Book was previously open, and the first or last Page was flipped successfully.
	 * @eventType	com.rubenswieringa.book.BookEvent.BOOK_CLOSED
	 ...
	 * @see			Book#status
	 */
	[Event(name="statusChanged", type="GNNC.UI.gnncBook.book.BookEvent")]
