package GNNC.UI.gnncBook.book {
	...
	import GNNC.UI.gnncBook.containers.SuperViewStack;
	import GNNC.UI.gnncBook.managers.StateManager;
	import GNNC.UI.gnncBook.utils.ChildTool;
	 ...
	 */
	[Event(name="contentChanged", type="GNNC.UI.gnncBook.book.BookEvent")]
