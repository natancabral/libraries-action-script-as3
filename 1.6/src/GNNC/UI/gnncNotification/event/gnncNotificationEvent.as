package GNNC.UI.gnncNotification.event
{
	 ...
	 */
	public class gnncNotificationEvent extends Event
	{
		/**
		...
		public function gnncNotificationEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false):void
		{
		...
		{
			return new gnncNotificationEvent(type);
		}  // clone
	}  // class declaration
}  // package