package GNNC.UI.gnncNotification
{
	...
	import GNNC.UI.gnncNotification.ui.gnncNotificationWindow;
	 ...
	 */
	public class gnncNotificationValues extends EventDispatcher
	{
		...
		private var notificationWindow:gnncNotificationWindow;
		 ...
		 */
		public function gnncNotificationValues(title:String = null, message:String = null, image:String = null, link:String = null, isCompact:Boolean = false, isSticky:Boolean = false, isReplayable:Boolean = true)
		{
			notificationWindow = new gnncNotificationWindow();
			...
			notificationWindow.title = gnncNotificationWindow.NOTIFICATION_IDENTIFIER;
		}  // Notification
		 ...
		 */
		public function open(notificationManager:gnncNotificationManager):void
		{
