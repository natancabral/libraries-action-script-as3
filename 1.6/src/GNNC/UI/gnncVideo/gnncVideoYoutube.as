...
package GNNC.UI.gnncVideo
{
	...
	public class gnncVideoYoutube extends Sprite 
	{
		...
		public function gnncVideoYoutube()
		{
		...
		private function handlePlayerReady(e:Event):void
		{
			...
			dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.READY ) );
		...
		private function handlePlayerStateChange(e:Object):void
		{
			...
			dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.STATE_CHANGED, state ) );
			
			switch ( state )
			{
				case 0:
					dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.ENDED ) );
				...
				case 1:
					dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.PLAYING ) );
				...
				case 2:
					dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.PAUSED ) );
				...
				case 3:
					dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.BUFFERING ) );
				...
				case 5:
					dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.QUEUED ) );
				...
				default:
					dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.NOT_STARTED ) );
		...
		{
			dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.QUALITY_CHANGED, getPlaybackQuality() ) );
		}
		
		private function handlePlayerError(e:Object):void
		{
			dispatchEvent( new gnncVideoYoutubeEvents( gnncVideoYoutubeEvents.ERROR, e ) );
		}
